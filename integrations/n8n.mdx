...
description: "Connect Ringyo AI to n8n for powerful workflow automation"
---
...
```json
{
  ...
  "parameters": {
    "method": "POST",
    "url": "https://www.ringyo.ai/api/v1/calls",
...
3. Set **URL** to `https://www.ringyo.ai/api/v1/calls`
...
<CardGroup cols={2}>
  <Card title="Lead Qualifier" icon="filter" href="https://www.ringyo.ai/templates/n8n-lead-qualifier.json">
    Automatically qualify leads with AI calls.
  </Card>
  <Card title="Appointment Reminder" icon="calendar" href="https://www.ringyo.ai/templates/n8n-appointment-reminder.json">
    Send reminder calls before appointments.
  </Card>
  <Card title="Follow-up Sequence" icon="repeat" href="https://www.ringyo.ai/templates/n8n-followup-sequence.json">
    Multi-touch follow-up automation.
  </Card>
  <Card title="CRM Sync" icon="sync" href="https://www.ringyo.ai/templates/n8n-crm-sync.json">
...
- Join our [Discord](https://discord.gg/ringyo)
