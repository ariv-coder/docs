...
description: 'Build powerful automations with VoiceBook AI and Make'
icon: 'wand-magic-sparkles'
---

<Info>
  The Make integration is coming soon. Join our [waitlist](https://voicebook.ai/integrations/make) to get early access.
</Info>

## Overview

Make (formerly Integromat) offers advanced automation capabilities with visual workflow builders. Our upcoming integration will bring VoiceBook AI's voice capabilities to your Make scenarios.
...
<Card title="Join the Waitlist" icon="bell" href="https://voicebook.ai/integrations/make">
...
2. Configure it to call the VoiceBook API
