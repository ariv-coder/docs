---
title: 'Get Agent'
api: 'GET https://www.ringyo.ai/api/v1/agents/{agent_id}'
...
<RequestExample>
```bash cURL
curl https://www.ringyo.ai/api/v1/agents/agent_abc123?include=stats \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript Node.js
const response = await fetch(
  'https://www.ringyo.ai/api/v1/agents/agent_abc123?include=stats',
  {
    headers: {
