---
title: 'Get Agent'
api: 'GET https://api.voicebook.ai/v1/agents/{agent_id}'
...
<RequestExample>
```bash cURL
curl https://api.voicebook.ai/v1/agents/agent_abc123?include=stats \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript Node.js
const response = await fetch(
  'https://api.voicebook.ai/v1/agents/agent_abc123?include=stats',
  {
    headers: {
