...
api: 'GET https://www.ringyo.ai/api/v1/phone-numbers/{phone_number_id}'
description: 'Retrieve details of a specific phone number'
---

<Warning>
  **Coming Soon** — This endpoint currently returns `501 Not Implemented`. Phone number management via API is under active development. For now, use the [Dashboard](https://www.ringyo.ai/dashboard) to view phone number details.
</Warning>
...
<RequestExample>
```bash cURL
curl https://www.ringyo.ai/api/v1/phone-numbers/pn_abc123?include=stats \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript Node.js
const response = await fetch(
  'https://www.ringyo.ai/api/v1/phone-numbers/pn_abc123?include=stats',
  {
    headers: {
...
response = requests.get(
    'https://www.ringyo.ai/api/v1/phone-numbers/pn_abc123',
