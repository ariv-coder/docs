...
api: 'GET https://api.voicebook.ai/v1/phone-numbers'
...
<RequestExample>
```bash cURL
curl "https://api.voicebook.ai/v1/phone-numbers?status=active" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript Node.js
const response = await fetch(
  'https://api.voicebook.ai/v1/phone-numbers?status=active',
  {
    headers: {
...
response = requests.get(
    'https://api.voicebook.ai/v1/phone-numbers',
