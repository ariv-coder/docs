...
api: 'GET https://www.ringyo.ai/api/v1/phone-numbers'
description: 'List all phone numbers in your account'
---

<Warning>
  **Coming Soon** — This endpoint currently returns `501 Not Implemented`. Phone number management via API is under active development. For now, use the [Dashboard](https://www.ringyo.ai/dashboard) to manage phone numbers.
</Warning>
...
<RequestExample>
```bash cURL
curl "https://www.ringyo.ai/api/v1/phone-numbers?status=active" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript Node.js
const response = await fetch(
  'https://www.ringyo.ai/api/v1/phone-numbers?status=active',
  {
    headers: {
...
response = requests.get(
    'https://www.ringyo.ai/api/v1/phone-numbers',
