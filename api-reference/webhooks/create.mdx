...
api: 'POST https://www.ringyo.ai/api/v1/webhooks'
...
<RequestExample>
```bash cURL
curl -X POST https://www.ringyo.ai/api/v1/webhooks \
...
```javascript Node.js
const response = await fetch('https://www.ringyo.ai/api/v1/webhooks', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://www.ringyo.ai/api/v1/webhooks',
    headers={
        'Authorization': 'Bearer YOUR_API_KEY',
        'Content-Type': 'application/json',
    },
