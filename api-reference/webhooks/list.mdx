---
title: 'List Webhooks'
api: 'GET https://api.voicebook.ai/v1/webhooks'
...
<RequestExample>
```bash cURL
curl "https://api.voicebook.ai/v1/webhooks?status=active" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript Node.js
const response = await fetch(
  'https://api.voicebook.ai/v1/webhooks?status=active',
  {
    headers: {
...
```json 200 - Success
{
  "data": [
    ...
    {
      "id": "wh_def456",
      "url": "https://staging.your-app.com/webhooks/voicebook",
      "events": ["*"],
