---
title: Webhooks
description: "Receive real-time notifications for VoiceBook AI events"
---

# Webhooks

Webhooks allow you to receive real-time notifications when events happen in VoiceBook AI. Instead of polling the API, events are pushed to your server automatically.

## How Webhooks Work

1. You register a webhook endpoint URL
2. Select which events you want to receive
3. When an event occurs, VoiceBook AI sends an HTTP POST to your URL
...
Always verify webhook signatures to ensure they came from VoiceBook AI.
...
```
X-VoiceBook-Signature: t=1705312800,v1=abc123...
```
...
1. VoiceBook AI retries up to **5 times**
